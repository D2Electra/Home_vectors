...
def setup():
    global delta_x, delta_y, x_coord, y_coord, my_point, another_point,one_point,red_line,green_point
    py5.size(500, 500)
    py5.background(0)
    #py5.stroke(255, 0, 0)
    py5.fill(255, 211, 0)
    ...
    green_point=[]
    for i in range(200):
        green_point.append(vect_point.Point(py5.random(150,200),py5.Py5Vector(py5.random(50,100),py5.random(50,100))))
...
def draw():
    global delta_x, delta_y, x_coord, y_coord, my_point, another_point,one_point,my_line,green_point
    py5.background(0)
